...
[![CRAN Version](https://www.r-pkg.org/badges/version/civ)](https://cran.r-project.org/package=civ)
<!-- badges: end -->
...
See the corresponding working paper [Optimal Categorical Instrumental Variables](https://arxiv.org/abs/2311.17021) for further discussion and theoretical details.
...
Since correct classification requires very few observations per instrument, CIV is nearly identical to the infeasible oracle estimator that presumes knowledge of the low-dimensional optimal instrument Z0:
